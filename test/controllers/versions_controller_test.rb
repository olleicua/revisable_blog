...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { content: @version.content, post_id: @version.post_id, time: @version.time, title: @version.title }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { content: @version.content, post_id: @version.post_id, time: @version.time, title: @version.title }
    assert_redirected_to version_path(assigns(:version))
  end
